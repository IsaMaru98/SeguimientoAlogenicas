...
class CosechaForm(forms.ModelForm):
    class Meta: 
        ...
        labels = {'loteCosecha': 'Lote:','fechaCosecha': 'Fecha cosecha:','paseCosecha': 'Pase cosecha:','areaFrascosCosecha':'Tipo de frasco Cosecha:','numFrascosCosecha': 'Número de frascos de cosecha:', 'numCelulasObtenidas': 'Número de células obtenidas:','viabilidadCosecha': 'Viabilidad obtenida:', 'cci': 'CCI:'}
        widgets = {
...
class SiembraForm(forms.ModelForm):
    class Meta: 
        ...
        labels = {'loteSimbra': 'Lote:' ,'fechaSiembra': 'Fecha Siembra:','paseSiembra':'Pase Siembra:','areaFrascosSiembra': 'Tipo de frasco Siembra:' , 'numFrascosSiembra': 'Número de frascos de Siembra:' ,'numCelulasSembradasXFrasco': 'Número de células sembradas por frasco:', 'cosechaFKSiembra': 'Cosecha de proveniencia', 'cci': 'CCI:' }
        widgets = {
